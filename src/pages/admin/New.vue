  ...
  <!-- <form action="">
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
      ...
      <div class="form-group">
        ...
        v-model="model.price" v-validate="'required'" name="price"
      ...
      <div class="form-group">
        ...
        <select type="text" class="form-control" v-model="model.manufacturer"
        v-validate="'required'" name="manufacturer"
        :class="{'form-control': true, 'error': errors.has('manufacturer') }">
          <div v-for="manufacturer in manufacturers" :key="manufacturer">
        ...
        <span class="small text-danger" v-show="errors.has('manufacturer')">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <div class="form-group">
        <label>Image</label>
        <input type="text" lass="form-control" placeholder="Image" v-model="model.image"
        v-validate="'required|url'" name="image" :class="{'form-control': true,
      ...
      <div class="form-group">
        ...
        <textarea type="number" class="form-control" placeholder="Description"
        rows="5" v-model="model.description" v-validate="'required'" name="description"
